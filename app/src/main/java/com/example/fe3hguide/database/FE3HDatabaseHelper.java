...
public class FE3HDatabaseHelper extends SQLiteOpenHelper {
    ...
    private void insertCharacters(SQLiteDatabase db) {
        ...
        insertCharacter(db, "Anna", R.drawable.ic_anna, "she/her", "Knights of Seiros", 25, "June 9", "Garland Moon 9_Imperial Year 1155", "Major Crest of Ernest", 28, 8, 8, 9, 11, 14, 6, 8, 9, "35%", "35%", "35%", "45%", "55%", "45%", "30%", "40%", "50%", "D_UP", "E", "E+_UP", "E+_UP", "E", "E_DOWN", "E+_UP", "E_DOWN", "E", "E$Pass", "E", "DLC only._Available after Chapter 3._No extra requirements.");
