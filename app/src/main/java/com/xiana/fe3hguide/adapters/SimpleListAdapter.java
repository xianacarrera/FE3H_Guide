...
public class SimpleListAdapter extends BaseAdapter implements Filterable, ISpinnerSelectedView {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (position == 0) {
            ...
            view = View.inflate(mContext, R.layout.searchable_spinner_view_list_item, null);
    ...
    public View getNoSelectionView() {
        View view = View.inflate(mContext, R.layout.searchable_spinner_view_no_selection_item, null);
        return view;
    }
